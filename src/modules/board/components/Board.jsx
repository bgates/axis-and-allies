...
const paths = ['start', 'repair', 'research', 'research/results', 'rockets', 'rockets/results', 'purchase', 'income', 'lend-lease', 'plan-combat', 'resolve-combat', 'select-casualties', 'land-planes', 'move-units', 'place-units', 'confirm-finish', 'order-units']
